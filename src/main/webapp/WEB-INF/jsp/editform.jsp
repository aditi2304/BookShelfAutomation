                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="/updateBook" class="needs-validation" novalidate>
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                <label for="validationCustom01">Book No:</label>
                                                <input name="bookNo" type="text" class="form-control" id="validationCustom01"  required>
...
<br><br>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input name="bookName" type="text" class="form-control" id="validationCustom02"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
 <br><br>
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input name="author" type="text" class="form-control" id="validationCustom03"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
</div>
<br><br>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                                ...
                                                <input name="edition" type="text" class="form-control" id="validationCustom04"   required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
